...
var on_start_field = document.getElementById("on_start");
var on_end_field = document.getElementById("on_end");
...
function get_config() {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            on_start_field.value = data.on_start;
            on_end_field.value = data.on_end;
...
function update_config() {
    var url = "/update-config?ssid=" + ssid_field.value +
        "&password=" + password_field.value +
        "&utc=" + utc_field.value +
        "&on_start=" + on_start_field.value +
        "&on_end=" + on_end_field.value +
        "&on_off=" + (off_field.checked ? "0" : "1");
    fetch(url)
